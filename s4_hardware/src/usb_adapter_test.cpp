...
class USBSerialTest : public USBSerial{
 public:
  USBSerialTest(): USBSerial{}{
    imu_pub_ = nh_.advertise<sensor_msgs::Imu>("data", 10);
    timer_dummy_ = nh_.createTimer(ros::Duration(1.0), &USBSerialTest::timerCallback, this);
...
int main(int argc, char **argv)
{
  ...
  //USBSerialTest usb_serial_test("/dev/ttyUSB0", 9600);
  USBSerialTest usb_serial_test{};
