...
int serial_to_serialcode(s4_comport::SerialCode *serialcode, std::string instring){
	/*return
	0:corrent
	-1:unavailable char
	-2:too long char
...
{
	ros::init(argc, argv, "s4_comport_seriallink_encoder");
	ros::NodeHandle n;
	//publicher
	seriallink_pub = n.advertise<s4_comport::SerialCode>("SerialLink_in", 1000);
	//Subscriber
