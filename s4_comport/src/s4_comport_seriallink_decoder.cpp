...
int serialcode_to_serial(std::string *outstring, s4_comport::SerialCode serialcode){
	char tmp_data[2];
...
void seriallink_callback(const s4_comport::SerialCode& cancode_msg){
	std::string outdata;
...
{
	ros::init(argc, argv, "s4_comport_seriallink_decoder");
	ros::NodeHandle n;
	//publicher
